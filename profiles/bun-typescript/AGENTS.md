...
- Read `package.json`, `tsconfig.json`, `biome.json`, and `.oxlintrc.json` before
  changing TypeScript or JavaScript.
...
- Run `bun run verify` after touched TypeScript, JavaScript, JSON, or CSS.
